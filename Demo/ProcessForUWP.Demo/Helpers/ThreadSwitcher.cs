...
namespace ProcessForUWP.Demo.Helpers
{
    ...
    public readonly struct CoreDispatcherThreadSwitcher(CoreDispatcher dispatcher, CoreDispatcherPriority priority = CoreDispatcherPriority.Normal) : IThreadSwitcher<CoreDispatcherThreadSwitcher>
    {
    ...
    /// <param name="priority">Specifies the priority for event dispatch.</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public readonly struct DispatcherQueueThreadSwitcher(DispatcherQueue dispatcher, DispatcherQueuePriority priority = DispatcherQueuePriority.Normal) : IThreadSwitcher<DispatcherQueueThreadSwitcher>
    {
        /// <summary>
        /// A <see cref="DispatcherQueue"/> whose foreground thread to switch execution to.
        /// </summary>
        private readonly DispatcherQueue dispatcher = dispatcher;

        /// <inheritdoc/>
        public bool IsCompleted => this.dispatcher is not DispatcherQueue dispatcher
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public readonly struct SynchronizationContextThreadSwitcher(SynchronizationContext context) : IThreadSwitcher<SynchronizationContextThreadSwitcher>
    {
        /// <summary>
        /// Specifies the priority for event dispatch.
        /// </summary>
        private readonly SynchronizationContext context = context;

        /// <inheritdoc/>
        public bool IsCompleted => this.context is not SynchronizationContext context
    ...
    /// <param name="priority">Specifies the priority for event dispatch.</param>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public readonly struct ThreadPoolThreadSwitcher(WorkItemPriority priority = WorkItemPriority.Normal) : IThreadSwitcher<ThreadPoolThreadSwitcher>
    {
